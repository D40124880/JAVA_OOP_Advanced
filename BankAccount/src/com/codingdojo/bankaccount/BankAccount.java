...
public class BankAccount {
	...
	//methods
	public void despositMoney(String acct, double value) {
		if(acct == "Checking") {
			addToChecking(value);
		}else if(acct == "Savings") {
			addToSaving(value);
		}else {
			System.out.println("Hey you did not send the right information!");
		}
	}
	...
	public void withdrawMoney(String acct, double value) {
		if(acct == "Checking") {
			...
			System.out.println("You are entering the wrong information");
		}
	}
